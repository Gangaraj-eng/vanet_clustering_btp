 ...
 * This header file contains type declarations of the variables required
 */
...
namespace ns3
{
  namespace molsr
  {
    ...
    // Overloading the comparisionoperator between two IfaceAssocTuple objects
    static inline bool
    ...
    // it prints interface address and main address and time in string format
    ...
    // A link tuple to maintain the link
    struct LinkTuple
    {
    ...
    // overloading comparitions operator
    static inline bool
    ...
    // A Neighbor tuple to maintain a neighbor
    struct NeighborTuple
    {
      // main address of neighbor node
      Ipv4Address neighborMainAddr;

      // status of link with neighbor node
      enum Status
      {
