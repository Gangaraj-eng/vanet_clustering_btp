...
namespace ns3
{
  namespace molsr
  {
    ...
    public:
       ...
       */
      const MolsrState &GetOlsrState() const;
    ...
    public:
       ...
       * local HNA associations to be sent by the node via HNA messages.
       * If this tuple does not exist, nothing is done (see "MolsrState::EraseAssociation()").
       *
       * \param networkAddr The network address.
       * \param netmask The network mask.
       */
    ...
    private:
      ...
      MolsrState m_state; //!< Internal state with all needed data structs.
      Ptr<Ipv4> m_ipv4;   //!< IPv4 object the routing is linked to.
      MessageHeader::NodeType m_nodetype;
    ...
    private:
       ...
       */
      void ForwardDefault(molsr::MessageHeader olsrMessage,
       ...
       */
      void ProcessHello(const molsr::MessageHeader &msg,
       ...
       *
       */
      void ProcessTc(const molsr::MessageHeader &msg, const Ipv4Address &senderIface);
       ...
       * \param senderIface the address of the interface where the message was sent from.
       */
      void ProcessMid(const molsr::MessageHeader &msg, const Ipv4Address &senderIface);
       ...
       *
       */
      void ProcessHna(const molsr::MessageHeader &msg, const Ipv4Address &senderIface);
       ...
       */
      void LinkSensing(const molsr::MessageHeader &msg,
       ...
       * \param hello The received HELLO sub-message.
       */
      void PopulateNeighborSet(const molsr::MessageHeader &msg,
                               const molsr::MessageHeader::Hello &hello);
       ...
       * \param hello The received HELLO sub-message.
       */
      void PopulateTwoHopNeighborSet(const molsr::MessageHeader &msg,
                                     const molsr::MessageHeader::Hello &hello);
       ...
       * \param hello The received HELLO sub-message.
       */
      void PopulateMprSelectorSet(const molsr::MessageHeader &msg,
                                  const molsr::MessageHeader::Hello &hello);
