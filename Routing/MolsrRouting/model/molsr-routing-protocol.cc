...
namespace ns3
{
    ...
    namespace molsr
    {
        ...
        {
            static TypeId tid =
                TypeId("ns3::molsr::RoutingProtocol")
                    ...
                    .AddTraceSource("Rx",
                                    ...
                                    "ns3::molsr::RoutingProtocol::PacketTxRxTracedCallback")
                    .AddTraceSource("Tx",
                                    "Send OLSR packet.",
                    ...
                    .AddTraceSource("RoutingTableChanged",
                                    ...
                                    "ns3::molsr::RoutingProtocol::TableChangeTracedCallback");
            return tid;
        }
        ...
        RoutingProtocol::SetIpv4(Ptr<Ipv4> ipv4)
        {
            NS_ASSERT(ipv4);
            NS_ASSERT(!m_ipv4);
            NS_LOG_DEBUG("Created molsr::RoutingProtocol");
            m_nodetype = MessageHeader::NodeType::CH;
        ...
        RoutingProtocol::RecvOlsr(Ptr<Socket> socket)
        {
            ...
            molsr::PacketHeader olsrPacketHeader;
                 ...
                 messageIter++)
            {
                ...
                if (duplicated == nullptr)
                {
                    ...
                    case molsr::MessageHeader::TC_MESSAGE:
                ...
                if (do_forwarding)
                {
                    ...
                    if (messageHeader.GetMessageType() != molsr::MessageHeader::HELLO_MESSAGE)
                    {
        ...
        void
        RoutingProtocol::ProcessHello(const molsr::MessageHeader &msg,
        ...
        void
        RoutingProtocol::ProcessTc(const molsr::MessageHeader &msg, const Ipv4Address &senderIface)
        {
            const molsr::MessageHeader::Tc &tc = msg.GetTc();
        ...
        void
        RoutingProtocol::ProcessMid(const molsr::MessageHeader &msg, const Ipv4Address &senderIface)
        {
            const molsr::MessageHeader::Mid &mid = msg.GetMid();
            Time now = Simulator::Now();
        ...
        void
        RoutingProtocol::ProcessHna(const molsr::MessageHeader &msg, const Ipv4Address &senderIface)
        {
            const molsr::MessageHeader::Hna &hna = msg.GetHna();
            Time now = Simulator::Now();
            ...
            for (std::vector<molsr::MessageHeader::Hna::Association>::const_iterator it =
        ...
        void
        RoutingProtocol::ForwardDefault(molsr::MessageHeader olsrMessage,
                                        DuplicateTuple *duplicated,
        ...
        void
        RoutingProtocol::QueueMessage(const molsr::MessageHeader &message, Time delay)
        {
        ...
        RoutingProtocol::SendQueuedMessages()
        {
            ...
            for (std::vector<molsr::MessageHeader>::iterator message = m_queuedMessages.begin();
                 ...
                 message++)
            {
                ...
                p->AddHeader(*message);
                packet->AddAtEnd(p);
                (*message).SetNodetype(m_nodetype);
        ...
        RoutingProtocol::SendHello()
        {
            ...
            msg.SetTimeToLive(1);
            msg.SetNodetype(m_nodetype);
            msg.SetHopCount(0);
            msg.SetMessageSequenceNumber(GetMessageSequenceNumber());
            molsr::MessageHeader::Hello &hello = msg.GetHello();
            hello.SetHTime(m_helloInterval);
            hello.willingness = m_willingness;

            std::vector<molsr::MessageHeader::Hello::LinkMessage> &linkMessages = hello.linkMessages;
                 ...
                 link_tuple++)
            {
                ...
                molsr::MessageHeader::Hello::LinkMessage linkMessage;
        ...
        RoutingProtocol::SendTc()
        {
            ...
            msg.SetMessageSequenceNumber(GetMessageSequenceNumber());
            msg.SetNodetype(m_nodetype);
            molsr::MessageHeader::Tc &tc = msg.GetTc();
            tc.ansn = m_ansn;
        ...
        {
            molsr::MessageHeader msg;
            molsr::MessageHeader::Mid &mid = msg.GetMid();
            msg.SetNodetype(m_nodetype);
        ...
        RoutingProtocol::SendHna()
        {
            ...
            msg.SetNodetype(m_nodetype);
            msg.SetMessageSequenceNumber(GetMessageSequenceNumber());
            molsr::MessageHeader::Hna &hna = msg.GetHna();

            std::vector<molsr::MessageHeader::Hna::Association> &associations = hna.associations;
            ...
            for (Associations::const_iterator it = localHnaAssociations.begin();
                 ...
                 it++)
            {
                molsr::MessageHeader::Hna::Association assoc = {it->networkAddr, it->netmask};
        ...
        void
        RoutingProtocol::LinkSensing(const molsr::MessageHeader &msg,
                                     const molsr::MessageHeader::Hello &hello,
                                     const Ipv4Address &receiverIface,
                                     const Ipv4Address &senderIface)
        {
            Time now = Simulator::Now();
            ...
            for (std::vector<molsr::MessageHeader::Hello::LinkMessage>::const_iterator linkMessage =
        ...
        void
        RoutingProtocol::PopulateNeighborSet(const molsr::MessageHeader &msg,
                                             const molsr::MessageHeader::Hello &hello)
        {
        ...
        void
        RoutingProtocol::PopulateTwoHopNeighborSet(const molsr::MessageHeader &msg,
                                                   const molsr::MessageHeader::Hello &hello)
        {
            Time now = Simulator::Now();
                 ...
                 link_tuple++)
            {
                ...
                typedef std::vector<molsr::MessageHeader::Hello::LinkMessage> LinkMessageVec;
        ...
        void
        RoutingProtocol::PopulateMprSelectorSet(const molsr::MessageHeader &msg,
                                                const molsr::MessageHeader::Hello &hello)
        {
            NS_LOG_FUNCTION(this);
...
molsr::mac_failed(Ptr<Packet> p)
{
    ...
    drop(p, DROP_RTR_MAC_CALLBACK);
        ...
        RoutingProtocol::AddNeighborTuple(const NeighborTuple &tuple)
        {
            ...
            //         Simulator::Now (),
            //         molsr::node_id(ra_addr()),
            //         molsr::node_id(tuple->neighborMainAddr),
        ...
        RoutingProtocol::AddTwoHopNeighborTuple(const TwoHopNeighborTuple &tuple)
        {
            ...
            //         molsr::node_id(ra_addr()),
            //         molsr::node_id(tuple->neighborMainAddr),
            //         molsr::node_id(tuple->twoHopNeighborAddr));
        ...
        RoutingProtocol::AddTopologyTuple(const TopologyTuple &tuple)
        {
            ...
            //         Simulator::Now (),
            //         molsr::node_id(ra_addr()),
            //         molsr::node_id(tuple->dest_addr()),
            //         molsr::node_id(tuple->last_addr()),
            //         tuple->seq());
        ...
        RoutingProtocol::AddIfaceAssocTuple(const IfaceAssocTuple &tuple)
        {
            ...
            //         molsr::node_id(ra_addr()),
            //         molsr::node_id(tuple->main_addr()),
            //         molsr::node_id(tuple->iface_addr()));
